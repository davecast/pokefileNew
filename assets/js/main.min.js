...
var SPRITE = 'https://www.pokemonlegends.com/images/monsters/animated/front/';
...
_APP.controller('homeController', ['$scope', '$timeout', '$interval', 'homeService', function ($scope, $timeout, $interval, homeService){
    ...
    $scope.nextPage = function(){
        homeService.allData($scope.next).then(function(data){
            if (data){
                $scope.allPokemons = data;
                $scope.next = data.data.next;
                $scope.prev = data.data.previous;
    ...
    $scope.prevPage = function(){
        homeService.allData($scope.prev).then(function(data){
            if (data) {
                $scope.allPokemons = data;
                $scope.next = data.data.next;
                $scope.prev = data.data.previous;
